...
PY_SCRIPT="eval_fact_count_v3_jsonl.py"

# 输入/输出路径（按你的单条命令默认值设置）
INPUT_JSON="/home/fmy/project/DPO-Summary/evaluate/ProCon/fact_halluc/qwen/45.jsonl"
OUTPUT_DIR="/home/fmy/project/DPO-Summary/evaluate/ProCon/fact_halluc/qwen/results_Qwen7b_summary_python_45.jsonl"
